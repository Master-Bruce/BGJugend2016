 ...
 */
public class TopProgressBarDrawable extends Drawable implements CloneableDrawable {
    ...
    public Drawable cloneDrawable() {
        final TopProgressBarDrawable copy = new TopProgressBarDrawable();
    ...
    private void drawHorizontalBar(Canvas canvas, int level, int color) {
        ...
        int ypos = bounds.top + mPadding + mBarWidth;
